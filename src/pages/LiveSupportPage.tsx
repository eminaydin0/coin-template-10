            ...
            <div className="max-w-7xl mx-auto relative">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-6">
                ...
                >
                  ...
                  >
                    7/24 kesintisiz destek ile her zaman yanınızdayız
                  </motion.p>
                </motion.div>
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                      ...
                      >
                        <div className="relative">
                          <MessageCircle className="h-12 w-12 text-blue-400/40" />
              ...
              <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <SupportFeatureCard key={index} feature={feature} index={index} />
                  ))}
                </div>
              </div>
            </div>
...
const SupportFeatureCard = ({ feature, index }: { feature: SupportFeature; index: number }) => {
